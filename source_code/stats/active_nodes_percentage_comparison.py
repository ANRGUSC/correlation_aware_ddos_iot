...
def plot_active_nodes_percentage_per_day(benign_dataset_path_list, date, output_path, colors, legends):
    plt.clf()
    fig, ax = plt.subplots()
...
def plot_active_nodes_percentage(benign_dataset_path_list, output_path, colors, legends):
    plt.clf()
    fig, ax = plt.subplots()
    for index, benign_dataset_path in enumerate(benign_dataset_path_list):
        data = load_dataset(benign_dataset_path)
...
def main_plot_active_nodes_percentage_per_day(benign_dataset_path_list, output_path, colors, legends):
    ...
    for date in dates:
        plot_active_nodes_percentage_per_day(benign_dataset_path_list, date, output_path, colors, legends)
...
def main():
    ...
    prepare_output_directory(output_path)
    main_plot_active_nodes_percentage_per_day(benign_dataset_path_list, output_path, colors, legends)
