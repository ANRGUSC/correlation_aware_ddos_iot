...
def main_generate_attack(dataset_directory_path, group_number, data_type, num_train_days, num_validation_days, num_test_days,
    ...
    attack_duration = [timedelta(hours=4), timedelta(hours=16)]
    attack_start_times = []
...
def main():
    ...
    for group_number in range(81):
        main_generate_attack(dataset_directory_path, group_number, 'train', num_train_days, num_validation_days, num_test_days, k_list, time_step, num_nodes)
        print('generate train data done.')
        main_generate_attack(dataset_directory_path, group_number, 'validation', num_train_days, num_validation_days, num_test_days, k_list, time_step, num_nodes)
        print('generate validation data done.')
        main_generate_attack(dataset_directory_path, group_number, 'test', num_train_days, num_validation_days, num_test_days, k_list, time_step, num_nodes)
